...
export default class PanTest extends Component {
  private leader: Animated.ValueXY;
  private follower: Animated.ValueXY;
  ...
  constructor(props: Readonly<{}>) {
    super(props);
    this.leader = new Animated.ValueXY({ x: 0, y: 0 });
    this.follower = new Animated.ValueXY({ x: 0, y: 0 });
  ...
  componentWillMount() {
    ...
    this.panResponder = PanResponder.create({
      ...
      onPanResponderMove: Animated.event([
        null,
        { dx: this.leader.x, dy: this.leader.y }
      ]),
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Animated.View
          style={[styles.box, leader]}
          {...this.panResponder.panHandlers}
        >
          <Text>Leader</Text>
        </Animated.View>
        <Animated.View
          style={[styles.box, follower, { opacity: this.opacity }]}
        >
          <Text>follower</Text>
        </Animated.View>
      </View>
